...
export const wellingtonParser: SourceParser = {
  key: 'wellington',
  displayName: 'Wellington Management',

  async discoverArticleUrls(_source: Source): Promise<DiscoveredUrl[]> {
    const urls = await fetchAndParseSitemap('https://www.wellington.com/sitemap.xml', 2)
    return urls
